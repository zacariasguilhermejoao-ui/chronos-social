  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-down": { "0%": { transform: "translateY(-120%)", opacity: "0" }, "100%": { transform: "translateY(0)", opacity: "1" } },
        "sound-pop": {
      ...
      animation: {
        ...
        "sound-pop": "sound-pop 0.7s ease-out forwards",
        "spin-slow": "spin 4s linear infinite",
        "coin-pop": "fade-in 0.6s ease-out",
      },
    },
  },
